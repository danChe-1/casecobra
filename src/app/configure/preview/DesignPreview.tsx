...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col items-center sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:grid md:gap-x-8 lg:gap-x-12">
        ...
        <div className="text-base sm:col-span-12 md:col-span-9">
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            <div>
              <p className="to-zinc-950 font-medium">Highlights</p>
            ...
            <div>
              <p className="font font-medium text-zinc-950">Materials</p>
              <ol className="mt-3 list-inside list-disc text-zinc-700">
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 flex justify-end pb-12">
              <Button onClick={hadnleCheckout} className="px-4 sm:px-6 lg:px-8">
