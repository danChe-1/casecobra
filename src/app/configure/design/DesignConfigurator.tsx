    ...
    <div className="relative mb-20 mt-20 grid grid-cols-1 pb-20 lg:grid-cols-3">
      ...
      >
        <div className="pointer-events-none relative aspect-[896/1831] w-60 bg-opacity-50">
          ...
          <div
            className={cn(
              "left[3px] bottompx absolute inset-0 right-[3px] top-px rounded-[33px]",
              `bg-${options.color.tw}`,
            )}
          />
        </div>
      ...
      <div className="col-span-full flex h-[37.5rem] w-full flex-col bg-white lg:col-span-1">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div
            aria-hidden="true"
            className="bg-graient-to-t pointer-events-none absolute inset-x-0 bottom-0 z-10 h-12 from-white"
          />
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          ...
                          className={cn(
                            "flex cursor-pointer items-center gap-1 p-1.5 text-sm hover:bg-zinc-100",
                            {
                              "bg-zinc-100":
                        ...
                        {selectableOptions.map((option) => (
                          <Radio
                            ...
                            className={({ focus, checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg border-2 border-zinc-200 bg-white px-6 py-6 shadow-sm outline-none ring-0 focus:outline-none focus:ring-0 sm:flex sm:justify-between",
                                {
