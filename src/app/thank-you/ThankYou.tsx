  ...
  if (data === false) {
    return (
      <div className="mt-24 flex w-full justify-center">
        <div className="flex flex-col items-center gap-2">
          <Loader2 className="size-8 animate-spin text-zinc-500" />
          <h3 className="text-xl font-semibold">Verigying your payment</h3>
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-zinc-500">
            We`ve recieved your order and are processing it now
          </p>
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              ...
              to look goo, but also last you for the years to come. We offer a
              5-year print guarantee: if your case doesn&apos;t satisfy your
              quality expectations, we`ll refund it!
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 border-t border-zinc-200 pt-10 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <p className="font-bold text-zinc-700">{formatPrice(amount)}</p>
          </div>
        </div>
      </div>
    </div>
